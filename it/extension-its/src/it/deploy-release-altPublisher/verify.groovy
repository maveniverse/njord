...
assert log2.contains("[INFO] Published ${artifactCount} artifact(s) to alt-deploy-release-service repository")
assert new File( basedir, "alt-releases-repo").isDirectory()
...
assert log5.contains("[INFO] Published ${artifactCount} artifact(s) to alt-deploy-snapshot-service repository")
assert new File( basedir, "alt-snapshots-repo").isDirectory()
