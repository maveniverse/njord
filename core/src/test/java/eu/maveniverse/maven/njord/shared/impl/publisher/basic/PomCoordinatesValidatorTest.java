...
import eu.maveniverse.maven.njord.shared.impl.Maven3ModelProvider;
...
public class PomCoordinatesValidatorTest extends ValidatorTestSupport {
    ...
    void pomWithRelocation() throws IOException {
        ...
        try (Context context = runtime.create(ContextOverrides.create().build())) {
            ...
            try (PomCoordinatesValidator subject = new PomCoordinatesValidator(
                    "test",
                    context.repositorySystemSession(),
                    context.remoteRepositories(),
                    new Maven3ModelProvider(context.repositorySystem()))) {
